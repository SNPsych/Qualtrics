...
from sleepvl.settings import SURVEY_DOWNLOADS_DIR, SURVEY_OUTPUT_DIR, SURVEY_FILE_PREFIX, REST_SURVEY_API_URL, \
    REST_API_PARAMS, \
    RSCRIPTS_COMMAND_PATH, R_PATH, R_ENV_PATH, INDEX_HTML_TPL_DIR, SURVEY_REPORT_DIR, SURVEY_LATEST_REPORT_DIR, \
    SURVEY_LATEST_REPORT_INDEX_DIR, \
    SURVEY_ENCRYPTED_REPORT_DIR
...
def survey_rest_call_job():
    ...
    surveyParser.gen_latest_reports(SURVEY_REPORT_DIR, SURVEY_LATEST_REPORT_DIR, SURVEY_ENCRYPTED_REPORT_DIR, today)
